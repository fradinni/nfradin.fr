...
var __stack = { lineno: 1, input: "<% include layout/header %>\n\n\t<h1>Test ! <%= typeof name !== \"undefined\" ? name : '' %></h1>\n\t<div id=\"content\">\n\t\t<a href=\"/\">Index</a>\n\t</div>\n\t\n<% include layout/footer %>", filename: "/Users/nicolas/Documents/GitPerso/nfradin.fr/build/www/templates/test.ejs" };
...
return buf.join('');})() + '\n\n	<h1>Test ! ', escape((__stack.lineno=3,  typeof name !== "undefined" ? name : '' )), '</h1>\n	<div id="content">\n		<a href="/">Index</a>\n	</div>\n	\n' + (function(){var buf = [];
 buf.push('	</body>\n</html>');
return buf.join('');})() + ''); })();
} 
return buf.join('');
